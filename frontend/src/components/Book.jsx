...
//   const [editingPage, setEditingPage] = useState(1); // Start from page 1 when book opens
...
//         setCustomization(processedPages[editingPage].customization);
//       }
...
//   // UPDATED: Turn page logic for both desktop and mobile
...
//         // Set editing page to the right page of the spread
...
//     setPages(prev =>
//       prev.map((p, i) => (i === pageIndex ? { ...p, customization: finalCustomization } : p))
//     );
//     if (editingPage === pageIndex) setCustomization(finalCustomization);
...
//       setPages(originalPages);
//       if (editingPage === pageIndex) setCustomization(originalPages[pageIndex].customization || {});
//     }
//   };

//   useEffect(() => {
//     if (!Array.isArray(pages) || pages.length <= editingPage) return;
//     setCustomization(pages[editingPage]?.customization || {});
//   }, [editingPage, pages]);

//   // UPDATED: Open book logic
//   const openBook = () => {
//     setIsBookOpen(true);
//     // Start from page 1 when book opens (skip cover)
//     const startPage = isMobile ? 1 : 0;
//     setCurrentPage(startPage);
//     setEditingPage(1); // Always start editing from page 1
//   };
...
//     if (isMobile) {
//       // Mobile: Direct navigation to single page
//       if (pageIndex >= 0 && pageIndex < pages.length) {
//         setCurrentPage(pageIndex);
//         setEditingPage(pageIndex);
//       }
//     } else {
//       // Desktop: Navigate to spread containing the page
...
//   // UPDATED: Handle page click for editing
//   const handlePageClick = (pageIndex, event) => {
//     if (pageIndex === 0) {
//       // Cover page - open book
//       if (!isBookOpen) {
//         openBook();
//       }
//       return;
...
//     // Set the clicked page as editing page
